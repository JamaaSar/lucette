...
// Returns the private 'App\Repository\MooveeUserHasCarRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MooveeUserHasCarRepository.php';

return $this->privates['App\\Repository\\MooveeUserHasCarRepository'] = new \App\Repository\MooveeUserHasCarRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
