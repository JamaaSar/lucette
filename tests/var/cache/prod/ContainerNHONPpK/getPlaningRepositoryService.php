...
// Returns the private 'App\Repository\PlaningRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PlaningRepository.php';

return $this->privates['App\\Repository\\PlaningRepository'] = new \App\Repository\PlaningRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
