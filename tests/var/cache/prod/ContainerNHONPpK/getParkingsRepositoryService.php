...
// Returns the private 'App\Repository\ParkingsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ParkingsRepository.php';

return $this->privates['App\\Repository\\ParkingsRepository'] = new \App\Repository\ParkingsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
