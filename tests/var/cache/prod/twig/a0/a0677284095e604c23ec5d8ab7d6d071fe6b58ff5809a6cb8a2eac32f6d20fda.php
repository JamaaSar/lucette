...
/* wellness/index.html.twig */
class __TwigTemplate_69a3b402ceedf7dc27e46ff3133ab1cdcb928fe5e1beb7ab4ac4881209532d5b extends \Twig\Template
{
    private $source;
    ...
    {
        $this->parent = $this->loadTemplate("layoutadmin.html.twig", "wellness/index.html.twig", 1);
...
\t\t<div class=\"header\">
\t\t\t<h4 style=\"text-align:center; \">Our dedicated wellness services
\t\t\t</h4>
\t\t</div>
\t\t<br>
\t\t<div class=\"col-md-12\">
...
\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["categories"]) {
                // line 92
                echo "\t\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["categories"], "service", [], "any", false, false, false, 92), "id", [], "any", false, false, false, 92) == 2)) {
                    // line 93
                    echo "\t\t\t\t\t\t\t<div class=\"polaroid col-md-6 col-lg-4\" style=\"padding-bottom:25px;\">
\t\t\t\t\t\t\t\t<form action=\"";
                    // line 94
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("wellness_productid", ["id" => twig_get_attribute($this->env, $this->source, $context["categories"], "id", [], "any", false, false, false, 94)]), "html", null, true);
                    echo "\" method=\"post\">
...
\t\t\t\t\t\t\t\t\t\t<img style='border-radius: 8px; display: block; width:350px; height:250px;
 margin-bottom: 25px;' src=\"";
                    // line 98
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl((("uploads/category/" . twig_get_attribute($this->env, $this->source, $context["categories"], "photo", [], "any", false, false, false, 98)) . "")), "html", null, true);
                    echo "\"/>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    // line 102
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categories"], "category", [], "any", false, false, false, 102), "html", null, true);
                    echo "
\t\t\t\t\t\t\t\t\t\t\t\t</strong>
\t\t\t\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t\t\t</div>
...
\t";
    ...
    {
        return "wellness/index.html.twig";
    }
    ...
    {
        return array (  235 => 139,  231 => 138,  227 => 137,  223 => 136,  219 => 134,  209 => 127,  199 => 119,  197 => 118,  194 => 117,  188 => 113,  182 => 112,  169 => 102,  162 => 98,  156 => 95,  152 => 94,  149 => 93,  146 => 92,  142 => 91,  139 => 90,  137 => 55,  134 => 54,  122 => 48,  118 => 46,  113 => 45,  101 => 39,  97 => 37,  92 => 36,  86 => 33,  81 => 30,  79 => 29,  55 => 7,  52 => 6,  45 => 3,  35 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "wellness/index.html.twig", "/home/lucettp/www/app/templates/wellness/index.html.twig");
    }
}
