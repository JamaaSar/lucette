...
// Returns the private 'App\Repository\PlannedCleaningRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PlannedCleaningRepository.php';

return $this->privates['App\\Repository\\PlannedCleaningRepository'] = new \App\Repository\PlannedCleaningRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
