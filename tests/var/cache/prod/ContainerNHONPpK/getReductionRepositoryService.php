...
// Returns the private 'App\Repository\ReductionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ReductionRepository.php';

return $this->privates['App\\Repository\\ReductionRepository'] = new \App\Repository\ReductionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
