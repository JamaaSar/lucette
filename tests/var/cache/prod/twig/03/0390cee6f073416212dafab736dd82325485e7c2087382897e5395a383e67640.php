...
/* hair_salon/locationchoice.html.twig */
class __TwigTemplate_7eb3e729e780b483b120b6d2dc19056981269651e6d2e446fd81e9dfc092cfb2 extends \Twig\Template
{
    private $source;
    ...
    {
        $this->parent = $this->loadTemplate("layoutadmin.html.twig", "hair_salon/locationchoice.html.twig", 1);
...
'";
            // line 81
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["res"], "parking", [], "any", false, false, false, 81), "id", [], "any", false, false, false, 81), "html", null, true);
            echo "',
'<form action=\"   ";
            // line 82
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("hairsalon_availbleDate");
...
";
            ...
            // line 85
            echo "'<strong>    ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["res"], "parking", [], "any", false, false, false, 85), "name", [], "any", false, false, false, 85), "html", null, true);
            echo "' + '<br>' + '";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["res"], "parking", [], "any", false, false, false, 85), "address", [], "any", false, false, false, 85), "html", null, true);
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["res"], "parking", [], "any", false, false, false, 85), "zipcode", [], "any", false, false, false, 85), "html", null, true);
            echo ",    ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["res"], "parking", [], "any", false, false, false, 85), "country", [], "any", false, false, false, 85), "html", null, true);
            echo "' + '<br><br>' + '<a href=\"    ";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("parking_detail", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["res"], "parking", [], "any", false, false, false, 85), "id", [], "any", false, false, false, 85)]), "html", null, true);
            ...
            if ((($context["achat"] ?? null) == false)) {
                ...
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["res"], "parking", [], "any", false, false, false, 86), "id", [], "any", false, false, false, 86), "html", null, true);
                echo "\" formaction=\"   ";
                echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("hairsalon_calendar");
                echo "\">Choose</button>'";
            }
...
'";
            // line 88
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["res"], "parking", [], "any", false, false, false, 88), "latitude", [], "any", false, false, false, 88), "html", null, true);
            echo "',
'";
            // line 89
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["res"], "parking", [], "any", false, false, false, 89), "longitude", [], "any", false, false, false, 89), "html", null, true);
            echo "',
count ++,";
            // line 90
            if ( !(null === twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["res"], "parking", [], "any", false, false, false, 90), "company", [], "any", false, false, false, 90))) {
                // line 91
                echo "\"";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl((("uploads/logo/" . twig_get_attribute($this->env, $this->source, $context["res"], "photo", [], "any", false, false, false, 91)) . "")), "html", null, true);
                echo "\"
";
            }
            // line 93
...
<script src=\"https://maps.googleapis.com/maps/api/js?key=AIzaSyBaYtB6Dqw9i7vWLXQ_e5U0dzn2X1FWd3M&sensor=false&callback=initialize\" type=\"text/javascript\"></script>";
    ...
    {
        return "hair_salon/locationchoice.html.twig";
    }
    ...
    {
        return array (  300 => 128,  265 => 95,  257 => 93,  251 => 91,  249 => 90,  245 => 89,  241 => 88,  226 => 86,  212 => 85,  203 => 83,  195 => 82,  191 => 81,  185 => 80,  154 => 52,  150 => 51,  146 => 50,  142 => 49,  138 => 48,  134 => 47,  130 => 46,  126 => 45,  118 => 39,  106 => 33,  102 => 31,  97 => 30,  85 => 24,  81 => 22,  76 => 21,  70 => 18,  65 => 15,  63 => 14,  55 => 8,  52 => 7,  45 => 3,  35 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "hair_salon/locationchoice.html.twig", "/home/lucettp/www/app/templates/hair_salon/locationchoice.html.twig");
    }
}
