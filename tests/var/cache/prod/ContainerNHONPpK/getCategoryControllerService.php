...
$this->services['App\\Controller\\CategoryController'] = $instance = new \App\Controller\CategoryController(($this->privates['App\\Repository\\CategoriesRepository'] ?? $this->load('getCategoriesRepositoryService.php')), ($this->privates['App\\Repository\\ServiceRepository'] ?? $this->load('getServiceRepositoryService.php')));
