...
class Service extends \App\Entity\Service implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Service' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Service' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Service' . "\0" . 'id_category'];
        }
     ...
     * {@inheritDoc}
     */
    public function setIdCategory(int $id_category): \App\Entity\Service
    {
