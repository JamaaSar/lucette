...
// Returns the private 'App\Repository\PlannedCleaningOptionsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PlannedCleaningOptionsRepository.php';

return $this->privates['App\\Repository\\PlannedCleaningOptionsRepository'] = new \App\Repository\PlannedCleaningOptionsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
