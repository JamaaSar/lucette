...
// Returns the private 'App\Repository\CategoryOptionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CategoryOptionRepository.php';

return $this->privates['App\\Repository\\CategoryOptionRepository'] = new \App\Repository\CategoryOptionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
