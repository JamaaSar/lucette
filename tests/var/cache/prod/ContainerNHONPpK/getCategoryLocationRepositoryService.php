...
// Returns the private 'App\Repository\CategoryLocationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CategoryLocationRepository.php';

return $this->privates['App\\Repository\\CategoryLocationRepository'] = new \App\Repository\CategoryLocationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
