...
// Returns the private 'App\Repository\CreditCardRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CreditCardRepository.php';

return $this->privates['App\\Repository\\CreditCardRepository'] = new \App\Repository\CreditCardRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
