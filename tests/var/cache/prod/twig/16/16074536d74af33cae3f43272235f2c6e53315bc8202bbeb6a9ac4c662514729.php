...
/* hair_salon/product.html.twig */
class __TwigTemplate_029dc1238c7397189e30b812dcae8b85447d067b29315b3a4def500eb2571c79 extends \Twig\Template
{
    private $source;
    ...
    {
        $this->parent = $this->loadTemplate("layoutadmin.html.twig", "hair_salon/product.html.twig", 1);
...
\t\t\t\t\t\t\t<form action=\"";
            // line 62
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("hairsalon_option", ["serviceid" => ($context["serviceId"] ?? null), "id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["product"], "idproduct", [], "any", false, false, false, 62), "id", [], "any", false, false, false, 62)]), "html", null, true);
            echo "\" method=\"post\">
...
\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 68
            $context["description"] = twig_replace_filter(strip_tags(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["product"], "idproduct", [], "any", false, false, false, 68), "description", [], "any", false, false, false, 68), ""), ["&nbsp;" => "", " /" => ". "]);
            // line 69
            echo "

\t\t\t\t\t\t\t\t\t\t\t\t<small class=\"text-uppercase\"> <b>";
            // line 71
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["product"], "idproduct", [], "any", false, false, false, 71), "name", [], "any", false, false, false, 71), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t-
\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 73
...
\t\t\t\t\t\t\t\t\t\t\t\t<span id=\"";
            // line 76
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["product"], "id", [], "any", false, false, false, 76), "html", null, true);
            echo "\">";
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
    ...
    {
        return "hair_salon/product.html.twig";
    }
    ...
    {
        return array (  248 => 103,  244 => 102,  240 => 101,  236 => 100,  232 => 99,  228 => 98,  224 => 97,  220 => 96,  216 => 95,  212 => 94,  201 => 86,  196 => 83,  181 => 76,  175 => 73,  170 => 71,  166 => 69,  164 => 68,  158 => 65,  153 => 63,  149 => 62,  145 => 60,  141 => 59,  135 => 55,  123 => 49,  119 => 47,  114 => 46,  102 => 40,  98 => 38,  93 => 37,  87 => 34,  82 => 31,  80 => 30,  55 => 7,  52 => 6,  45 => 3,  35 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "hair_salon/product.html.twig", "/home/lucettp/www/app/templates/hair_salon/product.html.twig");
    }
}
