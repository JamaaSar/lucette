 ...
 */
class GoogleCalendarApi extends \App\Entity\GoogleCalendarApi implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\GoogleCalendarApi' . "\0" . 'id', '' . "\0" . 'App\\Entity\\GoogleCalendarApi' . "\0" . 'iduser', '' . "\0" . 'App\\Entity\\GoogleCalendarApi' . "\0" . 'token', '' . "\0" . 'App\\Entity\\GoogleCalendarApi' . "\0" . 'calendarId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GoogleCalendarApi $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setIduser(?int $iduser): \App\Entity\GoogleCalendarApi
    {
     ...
     * {@inheritDoc}
     */
    public function setToken(array $token): \App\Entity\GoogleCalendarApi
    {
     ...
     * {@inheritDoc}
     */
    public function setCalendarId(string $calendarId): \App\Entity\GoogleCalendarApi
    {
