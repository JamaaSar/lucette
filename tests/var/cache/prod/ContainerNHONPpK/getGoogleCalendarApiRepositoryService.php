...
// Returns the private 'App\Repository\GoogleCalendarApiRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GoogleCalendarApiRepository.php';

return $this->privates['App\\Repository\\GoogleCalendarApiRepository'] = new \App\Repository\GoogleCalendarApiRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
