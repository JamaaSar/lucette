...
// Returns the private 'App\Repository\MooveeUsersRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MooveeUsersRepository.php';

return $this->privates['App\\Repository\\MooveeUsersRepository'] = new \App\Repository\MooveeUsersRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
