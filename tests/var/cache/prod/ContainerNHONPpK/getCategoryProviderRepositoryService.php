...
// Returns the private 'App\Repository\CategoryProviderRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CategoryProviderRepository.php';

return $this->privates['App\\Repository\\CategoryProviderRepository'] = new \App\Repository\CategoryProviderRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
