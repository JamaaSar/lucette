...
// Returns the private 'App\Repository\MooveeCarRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MooveeCarRepository.php';

return $this->privates['App\\Repository\\MooveeCarRepository'] = new \App\Repository\MooveeCarRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
