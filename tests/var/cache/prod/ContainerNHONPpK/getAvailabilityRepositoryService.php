...
// Returns the private 'App\Repository\AvailabilityRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AvailabilityRepository.php';

return $this->privates['App\\Repository\\AvailabilityRepository'] = new \App\Repository\AvailabilityRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
