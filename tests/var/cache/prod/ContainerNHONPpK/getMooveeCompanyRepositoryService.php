...
// Returns the private 'App\Repository\MooveeCompanyRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MooveeCompanyRepository.php';

return $this->privates['App\\Repository\\MooveeCompanyRepository'] = new \App\Repository\MooveeCompanyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
