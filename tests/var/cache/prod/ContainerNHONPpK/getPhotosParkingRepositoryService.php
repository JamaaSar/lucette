...
// Returns the private 'App\Repository\PhotosParkingRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PhotosParkingRepository.php';

return $this->privates['App\\Repository\\PhotosParkingRepository'] = new \App\Repository\PhotosParkingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
