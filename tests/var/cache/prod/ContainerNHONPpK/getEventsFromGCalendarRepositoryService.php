...
// Returns the private 'App\Repository\EventsFromGCalendarRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EventsFromGCalendarRepository.php';

return $this->privates['App\\Repository\\EventsFromGCalendarRepository'] = new \App\Repository\EventsFromGCalendarRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
